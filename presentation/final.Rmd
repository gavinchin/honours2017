...
```{r, echo = FALSE, fig.retina = 6, message=FALSE, warning=F, fig.height = 3.25, fig.align='center'}
...
- Code, presentation and thesis at [github.com:gavinchin/honours2017](github.com:gavinchin/honours2017)
