...
Because of the size of the data, with 3 years of hourly data at 43 sensor locations, the estimated model objects given by the base R GLM estimation function are very large. A complete model which contains a 
