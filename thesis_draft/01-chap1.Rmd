...
p1 <- ggplot(data = NULL, aes(x = ori_ts2[, "Melbourne Central"],
           ...
           xlab("Actual Pedestrian Count") +
           ylab("Predicted Pedestrian Count \n by simple imputation method")
p2 <- ggplot(data = NULL, aes(x =ori_ts2[, "Melbourne Central"],
