...
# Goodness of Fit
### Visually
```{r, fig.align= 'center', fig.height=24, fig.width=10, fig.retina=4, cache=TRUE, echo=FALSE}
...
```{r, fig.align= 'center', fig.retina = 4, cache=TRUE}
ggplot(test_fitted %>%
...
```{r, echo=FALSE, fig.align='center', fig.retina=4, cache=TRUE}
ggplot(test_fitted %>%
         filter(Date > "2017-07-23",
...
```{r, fig.align= 'center', fig.retina=3, echo=FALSE, cache=TRUE}
