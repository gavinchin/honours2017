...
test_df <- test_fitted %>% mutate(residsq = (Fitted - Hourly_Counts)^2) %>%
            split(.$Sensor_ID)
test_df_rmse <- data.frame(Sensor_ID = rep(0,43), RMSE = rep(0, 43))
  for (i in 1:43) {
