...
\begin{center}
Figure 4: Interactive data visualisation created using Tableau
\end{center}  
...
Once a model for forecasting the data has been established, an interactive web application to present the model will be developed. A key aspect which we want to include is the ability for the end user to forecast pedestrian activity in the future. 
