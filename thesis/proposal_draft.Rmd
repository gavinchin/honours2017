...
\begin{center}
\textbf{Figure 3}: Pedestrian Counting System Visualisation from www.pedestrian.melbourne.vic.gov.au - The UI allows the user to choose specific dates and hours of the day to visualise on a 3D perspective map
...
```
\begin{center}
\textbf{Figure 5}:  Sample of hourly counts of pedestrians at Flagstaff Station (June 2016)
\end{center}  
