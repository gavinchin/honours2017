...
```{r, message= FALSE, warning= FALSE, fig.height=4, echo = FALSE}
  ggplot(ped_df[ped_df$Sensor_ID == "3", ]) + 
    ...
    xlab(NULL) + ylab("Pedestrian Count") + 
    ggtitle(ped_loc$`Sensor Description`[ped_loc$`Sensor ID` == "3"]) +
    facet_wrap(~ Day) + theme(plot.title = element_text(hjust = 0.5))
```
...
## References  
  1. City of Melbourne, _'About Melbourne Data'_, https://data.melbourne.vic.gov.au/about, _accessed 18 April 2017_  
  2. City of Melbourne, _'Pedestrian Counting System'_,  
  http://www.pedestrian.melbourne.vic.gov.au/pdf/CityofMelbournePedestrianCountingSystem.pdf 4 May 2015, _accessed 18 April 2017_  
