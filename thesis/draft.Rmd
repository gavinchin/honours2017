...
```{r, echo = FALSE, message=FALSE, warning=F, fig.width=10, fig.height=5}
...
p3 <- ggplot() + geom_point(aes(x = MARE_base_glm_tr, y = MARE_tr,
      ...
      geom_abline(aes(slope = 1, intercept = 0)) +
      scale_colour_viridis(discrete = TRUE, name = "Improved Model is better") +
      theme_minimal() + labs(x = "Simple MARE", y = "Improved MARE") +
      theme(aspect.ratio = 1, legend.position = "bottom",
            legend.direction = "vertical")
```

```{r, fig.height=3.5, fig.width=9, fig.cap="Distribution of in-sample (2014-2016 data) MARE by imputation model"}
...
```{r, fig.cap="A plot of the pedestrian counts at Southern Cross Station. The black line is the observed counts, where the red line is the imputed counts."}
